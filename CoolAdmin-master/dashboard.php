            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-calendar-alt"></i>Widgets</a>
                        </li>
                        <li>
                            <a href="map.html">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-folder-open"></i>Categories</a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-plus"></i>Widgets</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-gear"></i>Settings</a>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <div class="rs-select2--light rs-select2--md">
                                            <select disabled class="js-select2" name="property">
                                        ...
                                        <div class="rs-select2--light rs-select2--sm">
                                            <select disabled class="js-select2" name="time">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a href="./additem.php" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <?php
                                        $sql = "select * from tbspecialoffer";
                                        $query = $obj->link()->query($sql);
                                        $i = 0;
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <span class="block-email"><?php echo $duration_ ?></span>
                                                </td>
                                                <td class="desc"><?php echo $descrip_ ?></td>
                                                <td><?php echo date('d-m-Y'); ?></td>
                                                <td><?php echo $price_ . '$'?></td>
                                                <td>
                                                    <span class="status--process">Special offer</span>
                                                </td>
                                                <td>
